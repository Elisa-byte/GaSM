        ...
        <div class="wrap-report">
            <div class="card-4 ">
                <div class="testbox">
                    ...
                    ?>
                    <form class="form-login" action="includes/form-raport.inc.php" name="FormularRaportare"
                        ...
                        <div class="question-answer">
                            <div class="upload-btn-wrapper">
                                <input type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)"
                                       style="display: none;">
                                <label for="file" style="cursor: pointer;" class="form-signup-button-submit">Incarcati o
                                    imagine</label>
