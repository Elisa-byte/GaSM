<input type="checkbox" id="overlay-checkbox" onclick="myFunction()"/>
    <div id="overlay-menu">
        <ul class="top-nav--overlayed">
            <li class="top-nav__link--overlayed"><a href="home">Home</a></li>
            ...
            <li class="top-nav__link--overlayed"><a href="campanie">Campanii</a></li>
            <li class="top-nav__link--overlayed"><a href="user/profile">View User Profile</a></li>
            <li class="top-nav__link--overlayed"><a href="user/accountSettings">Config Account</a></li>
            <li class="top-nav__link--overlayed"><a href="home/logout">Log Out</a></li>
    ...
    <header class="top-bar">
        <a href="home" id="top-bar__logo-container"><img src="public/img/logo-white.PNG" alt="GaSM Logo" id="top-bar__logo"></a>
        <ul class="top-nav">
            <li class="top-nav__link"><a href="home">Home</a></li>
            ...
            <li class="top-nav__link"><a href="campanie">Campanii</a></li>
        </ul>
        ...
        <div class="user-profile">
            ...
            <ul class="user-options">
                <div id="arrowup"></div>
                <li class="user__option"><a href="user/profile">View User Profile</a></li>
                <li class="user__option"><a href="user/accountSettings">Config Account</a></li>
                <li class="user__option"><a href="home/logout">Log Out</a></li>
