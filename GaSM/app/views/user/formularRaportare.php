...
//     $this->view('home/login','');//login.php//daca nu e logat nu intra in settings
                    ...
                    <form class="form-login" action="user/sendReport" name="FormularRaportare"
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Da" name="observeIncident"/>Da</label>
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Nu" name="observeIncident"/>Nu</label>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="question-answer">
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Da" name="recognizePerson"/>Da</label>
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Nu" name="recognizePerson"/>Nu</label>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="question-answer">
                                <div class="selection-category-person">
                                    <select name="typeLitter" tabindex="-1" class="selection-category-hidden-accessible"
                                            aria-hidden="true">
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <div class="selection-category-person">
                                    <select name="quantity" tabindex="-1" class="selection-category-hidden-accessible"
                                            aria-hidden="true">
                        ...
                        <div>
                            <h4 class="h4-report">Va rugam completati cu informatii referitoare la persoana
                                incriminata</h4>
                            <div class="question-answer">
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Masina" name="carType"/>Masina</label>
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Remorca" name="carType"/>Remorca</label>
                                <label class="label-report"><input class="input-report-login-signup-AS" type="radio"
                                                                   value="Aruncate din masini de mare tonaj"
                                                                   name="carType"/>Aruncate din masini de mare
                                    tonaj</label></br>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <div class="selection-category-person">
                                    <select name="colorCar" tabindex="-1" class="selection-category-hidden-accessible"
                                            aria-hidden="true">
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <div class="selection-category-person">
                                    <select name="modelCar" tabindex="-1" class="selection-category-hidden-accessible"
                                            aria-hidden="true">
                                        ...
                                        <option value="Gräf &amp; Stift">Gräf &amp; Stift</option>
                                        ...
                                        <option value="NextEV">NextEV</option>
                                        ...
                                        <option value="Wietmarscher">Wietmarscher</option>
                                        <option value="Williams">Williams</option>
                                        <option value="Willys">Willys</option>
                                        <option value="Winnebago">Winnebago</option>
                                        <option value="Wohnanhänger">Wohnanhänger</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="question-answer">
                                <div class="selection-location-person">
                                    <select name="judet" tabindex="-1" class="selection-location-hidden-accessible"
                                            aria-hidden="true">
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <input class="form-input" type="text" placeholder="ex: Targul Frumos"
                                       name="localitate"/>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="question-answer">
                                <input class="form-input" type="date" name="dateReport" placeholder="zz/ll/aaaa"
                        ...
                        <div class="question-answer">
                            <div class="btn-block">
                                <button class="form-login-button-submit" type="submit" name="raport-submit">Trimiteti
                                    formularul
                                </button>
                            </div>
                        </div>
